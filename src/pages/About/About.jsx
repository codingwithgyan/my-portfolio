...
const About = () => {
    return (
        <Box className="about-main-container">
            ...
            Results-driven Frontend Developer with more than 3 years of experience specializing in React.js, Next.js, and Node.js. Expertise in designing scalable and responsive web applications that improve user experience and business outcomes. Proven ability to lead projects that enhance website performance, SEO, and client engagement. Seeking to leverage my technical skills in a dynamic environment to contribute to cutting-edge software solutions.
            </Typography>
    </Box>)
}
